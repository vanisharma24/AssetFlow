      ...
      <div className="w-full max-w-md bg-white rounded-2xl shadow-xl overflow-hidden border border-slate-100 relative">
        ...
        <div className="p-8 relative z-10">
          ...
          <div className="space-y-4 p-0">
            ...
            <button className="w-full h-12 mt-4 bg-gradient-to-t from-emerald-600 via-emerald-500 to-emerald-400 hover:from-emerald-700 hover:via-emerald-600 hover:to-emerald-500 text-white font-semibold rounded-xl transition-all duration-200 shadow-sm hover:shadow-md hover:shadow-emerald-100 active:scale-[0.98] inline-flex items-center justify-center whitespace-nowrap text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500/50">
              Sign Up
            </button>

            <div className="flex items-center my-4">
              <div className="flex-1 h-px bg-slate-100"></div>
              <span className="px-4 text-xs text-slate-400 font-medium">
                or register with
              </span>
              <div className="flex-1 h-px bg-slate-100"></div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <button className="h-12 bg-white border border-slate-200 text-slate-700 hover:bg-slate-50 hover:text-slate-900 hover:border-slate-300 rounded-xl flex items-center justify-center gap-2 transition-all duration-200 inline-flex whitespace-nowrap text-sm font-semibold focus:outline-none focus:ring-2 focus:ring-slate-100">
                <svg
                  width="18"
                  height="18"
                  viewBox="0 0 24 24"
